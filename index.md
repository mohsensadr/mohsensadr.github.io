...
<head>
    ...
    * {
    ...
    <style>
        ...
        header {
            background-image: url('profile2.jpg'); /* Replace 'IMG_0006.jpg' with the actual path to your image */
            ...
            height: 120vh; /* Sets the header's height to 50% of the viewport height */
            margin-top: 90px;
        }
