...
<div class="image-grid" style="display: flex; flex-wrap: wrap; gap: 10px; justify-content: space-between;">
    <div class="image-container" style="flex: 0 0 50%; max-width: 50%; box-sizing: border-box;">
